        ...
        <div className="bg-card rounded-3xl p-8 shadow-[var(--shadow-card)] border border-border">
          <div className="flex gap-1 p-1 bg-muted rounded-full mb-6">
            ...
            <button
              ...
              className={`flex-1 py-2.5 rounded-full text-sm font-bold transition ${
                mode === "signup" ? "bg-white text-foreground shadow" : "text-muted-foreground"
              }`}
            >
              Регистрация
            </button>
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full py-3 rounded-full border-2 border-border bg-white font-bold text-sm hover:border-brand-blue transition flex items-center justify-center gap-3 disabled:opacity-50"
          >
